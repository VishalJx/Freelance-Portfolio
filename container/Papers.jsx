...
const Papers = () => {
  ...
  return (
    <section id="publications" className='flex flex-col items-center lg:items-start mt-28 lg:mt-24 gap-3'>
        ...
        <div className='w-full'>
            {
                paperContent.map((paper, index) => (
                    <Link href={paper.link} key={index} className='relative w-[80vw] mx-auto lg:w-[50vw] xl:w-[35vw] flex flex-col gap-3 lg:gap-6 px-5 py-3 mt-6 rounded-xl hover:bg-[#191919] duration-300'>
